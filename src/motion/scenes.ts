...
export type SceneName = 'title' | 'scale' | 'bands' | 'cities' | 'focus' | 'closing';
...
export const SCENES: readonly Scene[] = [
  { name: 'title', start: 0, duration: 4.2 },
  { name: 'scale', start: 4.2, duration: 6.0 },
  { name: 'bands', start: 10.2, duration: 10.0 },
  { name: 'cities', start: 20.2, duration: 9.0 },
  { name: 'focus', start: 29.2, duration: 11.0 },
  { name: 'closing', start: 40.2, duration: 5.8 },
];
